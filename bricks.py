...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
def stochastic_depth(input: torch.Tensor, p: float, training: bool =  True):
    ...
    random_tensor = survival_rate + torch.rand(shape, dtype=input.dtype, device=input.device)
    # scaling the remaining parameters accordingly to account for inference time. input / survival_rate.
    output = input.div(survival_rate) * random_tensor.floor()
